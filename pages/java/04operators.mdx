...
## DIY: You need Practice! 🎉

First assign `10` to `num1` and `5` to `num2`.
Subtract `num2` from `num1` and store the result in `num3`.
Set isEquals to true if `num3` is equal to `num2`.
Print the value of `isEquals` to the screen.
...
int num1 = 10;
int num2 = 5;`}
  keywords={["int","num1","=","10",";","int","num2","=","5",";","int","num3","=","num1","-","num2",";","boolean","isEquals","=","num","==","num",";","System.out.println","(","isEquals",")",";"]}
  correctOutput={`true`}
/>
